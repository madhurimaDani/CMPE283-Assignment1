...
struct capability_info procbased2[27] =
{
	...
	{ 22, "Mode Based Execute Contro For EPT"},
...
struct capability_info exitt[14] =
{
	{ 2, "Save Debug Controls"},
	{ 9, "Host Address Space Size"},
	{ 12, "Load IA32 Perf Global Control"},
	...
	{ 23, "Clear IA32 BNDCFGS"},
	{ 24, "Conceal VMX From PT"},
	{ 25, "Clear IA32 RTIT CTL"},
	{ 28, "Load CET State"},
	{ 29, "Load PKRS"}
};
...
struct capability_info entry[12] =
{
	...
	{ 13, "Load IA32 Perf Global Control"},
	{ 14, "Load IA32 PAT"},
	{ 15, "Load IA32 EFER"},
	{ 16, "Load IA32 BNDCFGS"},
	{ 17, "Conceal VMX From P"},
	{ 18, "Load IA32 RTIT CTL"},
	{ 20, "Load CET State"},
	{ 22, "Load PKRS"}
};
/*
...
detect_vmx_features(void)
{
	...
	pr_info("######Exit Controls MSR: 0x%llx\n",
		(uint64_t)(lo | (uint64_t)hi << 32));
	report_capability(exitt, 14, lo, hi);
